...
def draw_boxplot(num1, num2, num3, num4, num5, num6,
    ...
    num13 = np.array(num12)
    num14 = np.array(num14)
    num15 = np.array(num15)
    num16 = np.array(num16)
    num17 = np.array(num17)
    num18 = np.array(num18)

    num19 = np.array(num19)
    num20 = np.array(num20)
    num21 = np.array(num21)
    num22 = np.array(num22)
    num23 = np.array(num23)
    num24 = np.array(num24)
    ...
    df16 = pd.DataFrame(num16, columns=['delta'])
    df16['time'] = 'pre'
    df16['city'] = 'Humacao'
    df17 = pd.DataFrame(num17, columns=['delta'])
    df17['time'] = 'post1'
    df17['city'] = 'Humacao'
    df18 = pd.DataFrame(num18, columns=['delta'])
    df18['time'] = 'post2'
    df18['city'] = 'Humacao'

    df19 = pd.DataFrame(num19, columns=['delta'])
    df19['time'] = 'pre'
    df19['city'] = 'Ponce'
    df20 = pd.DataFrame(num20, columns=['delta'])
    df20['time'] = 'post1'
    df20['city'] = 'Ponce'
    df21 = pd.DataFrame(num21, columns=['delta'])
    df21['time'] = 'post2'
    df21['city'] = 'Ponce'

    df22 = pd.DataFrame(num22, columns=['delta'])
    df22['time'] = 'pre'
    df22['city'] = 'San Juan'
    df23 = pd.DataFrame(num23, columns=['delta'])
    df23['time'] = 'post1'
    df23['city'] = 'San Juan'
    df24 = pd.DataFrame(num24, columns=['delta'])
    df24['time'] = 'post2'
    df24['city'] = 'San Juan'
    ...
    df = pd.concat([df1, df2, df3, df4, df5, df6,
                    ...
                    df19, df20, df21, df22, df23, df24], axis=0)
...
if __name__=="__main__":
    ...
    oneDayAllPixelsValueAreciboPre = getEachDistrictHist(dataFile_Arecibo, '2017-09-02')
    oneDayAllPixelsValueAreciboPost = getEachDistrictHist(dataFile_Arecibo, '2017-09-28')
    oneDayAllPixelsValueAreciboPost2 = getEachDistrictHist(dataFile_Arecibo, '2017-11-14')

    oneDayAllPixelsValueCarolinaPre = getEachDistrictHist(dataFile_Carolina, '2017-09-02')
    oneDayAllPixelsValueCarolinaPost = getEachDistrictHist(dataFile_Carolina, '2017-09-28')
    oneDayAllPixelsValueCarolinaPost2 = getEachDistrictHist(dataFile_Carolina, '2017-11-14')

    oneDayAllPixelsValueCaguasPre = getEachDistrictHist(dataFile_data, '2017-09-02')
    oneDayAllPixelsValueCaguasPost = getEachDistrictHist(dataFile_data, '2017-09-28')
    oneDayAllPixelsValueCaguasPost2 = getEachDistrictHist(dataFile_data, '2017-11-14')

    oneDayAllPixelsValueGuayamaPre = getEachDistrictHist(dataFile_Guayama, '2017-09-02')
    oneDayAllPixelsValueGuayamaPost = getEachDistrictHist(dataFile_Guayama, '2017-09-28')
    oneDayAllPixelsValueGuayamaPost2 = getEachDistrictHist(dataFile_Guayama, '2017-11-14')

    oneDayAllPixelsValueHumacaoPre = getEachDistrictHist(dataFile_Humacao, '2017-09-02')
    oneDayAllPixelsValueHumacaoPost = getEachDistrictHist(dataFile_Humacao, '2017-09-28')
    oneDayAllPixelsValueHumacaoPost2 = getEachDistrictHist(dataFile_Humacao, '2017-11-14')

    oneDayAllPixelsValuePoncePre = getEachDistrictHist(dataFile_Ponce, '2017-09-02')
    oneDayAllPixelsValuePoncePost = getEachDistrictHist(dataFile_Ponce, '2017-09-28')
    oneDayAllPixelsValuePoncePost2 = getEachDistrictHist(dataFile_Ponce, '2017-11-14')
    ...
    draw_boxplot(
        oneDayAllPixelsValueAreciboPre, oneDayAllPixelsValueAreciboPost, oneDayAllPixelsValueAreciboPost2,
        oneDayAllPixelsValueBayamonPre, oneDayAllPixelsValueBayamonPost, oneDayAllPixelsValueBayamonPost2,
        oneDayAllPixelsValueCarolinaPre, oneDayAllPixelsValueCarolinaPost, oneDayAllPixelsValueCarolinaPost2,
        oneDayAllPixelsValueCaguasPre, oneDayAllPixelsValueCaguasPost, oneDayAllPixelsValueCaguasPost2,
        oneDayAllPixelsValueGuayamaPre, oneDayAllPixelsValueGuayamaPost, oneDayAllPixelsValueGuayamaPost2,
        oneDayAllPixelsValueHumacaoPre, oneDayAllPixelsValueHumacaoPost, oneDayAllPixelsValueHumacaoPost2,
        oneDayAllPixelsValuePoncePre, oneDayAllPixelsValuePoncePost, oneDayAllPixelsValuePoncePost2,
        oneDayAllPixelsValueSanJuanPre, oneDayAllPixelsValueSanJuanPost, oneDayAllPixelsValueSanJuanPost2,
    )
    # draw_distribution_histogram(oneDayAllPixelsValueBayamonPre,oneDayAllPixelsValueSanJuanPre, True, False)
