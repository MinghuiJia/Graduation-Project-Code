...
def drawPlot(time,value,smooth_value,key_words):
...
if __name__=="__main__":
    ...
    for country_english in country_dic:
        ...
        # dataFile_Arecibo_beforefit =work_dir + time_series_type + "\\TS_output_withoutMoonIlluminationAndSnow_1%_1invalid_"+country_english+"_more50_wholeSeries_Prophet"
        ...
        # smooth_value_beforefit = Kalman1D(total_value_beforefit, 0.1)
        ...
        drawPlot(total_time,total_value_afterfit,smooth_value_new_afterfit,country_dic[country_english])
